  ...
  implements PlugIn
{
  ...
  public void run(String arg)
  {
    ...
    System.out.println(this.fileNameStart);
  ...
  private ImagePlus mergingIteratively(String fn, String fp, ImagePlus imgStart)
  {
   ...
   tryFile = fn.substring(0,fn.indexOf("X",0)+1)  +  Integer.toString(coord[0]) + "_Y" +  Integer.toString(coord[1]+1) +".tif";
   ...
   if (imgTry == null){
	   ...
	   tryFile = fn.substring(0,fn.indexOf("X",0)+1)  +  Integer.toString(this.coord[0]+1) + "_Y" +  Integer.toString(this.coord[1]) +".tif";
	   tryPath = fpp + tryFile;
	   System.out.println(tryFile);
